...
export const DEFAULT_META: PageMeta = {
  title: 'BunnyMoonFarm',
  description:
    'Earn BUNNYMOON through yield farming or win it in the Lottery, then stake it in Pools to earn more tokens! Initial Farm Offerings (new token launch model pioneered by BunnyMoonFarm), NFTs, and more, on a platform you can trust.',
  image: 'https://bunnymoonfarm.web.app/images/hero2.png',
}
