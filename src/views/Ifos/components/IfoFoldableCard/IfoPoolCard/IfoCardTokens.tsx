...
import { Text, Flex, Box, Image, CheckmarkCircleIcon, FlexProps, HelpIcon, useTooltip } from '@bunnymoon-libs/uikit'
...
const IfoCardTokens: React.FC<IfoCardTokensProps> = ({
  ...
  const renderTokenSection = () => {
    ...
    if (account && !hasProfile) {
      return <Text textAlign="center">{t('You need an active BunnyMoonFarm Profile to take part in an IFO!')}</Text>
    }
    ...
    if (publicIfoData.status === 'live') {
      return (
        <>
          <TokenSection img="/images/farms/bunnymoon-bnb.png" mb="24px">
