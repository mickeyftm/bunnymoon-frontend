...
import { Heading, CardBody, CardFooter, PancakeRoundIcon, TicketRound } from '@bunnymoon-libs/uikit'
      ...
      <>
        <CardBody>
          <CardHeading>
            ...
            <LotteryCardHeading valueToDisplay={t(`${poolSize.toLocaleString()} BUNNYMOON`)} Icon={PancakeRoundIcon}>
              {t('Total prizes')}
            </LotteryCardHeading>
          </CardHeading>
        </CardBody>
