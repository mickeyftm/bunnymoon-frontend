...
import { Modal, Text, Flex, Button, HelpIcon, AutoRenewIcon, useTooltip } from '@bunnymoon-libs/uikit'
...
const BountyModal: React.FC<BountyModalProps> = ({
  ...
  const handleConfirmClick = async () => {
    cakeVaultContract.methods
      ...
      .on('receipt', () => {
        toastSuccess(t('Bounty collected!'), t('BUNNYMOON bounty has been sent to your wallet.'))
        setPendingTx(false)
        onDismiss()
      })
      .on('error', (error) => {
    ...
    <Modal title={t('Claim Bounty')} onDismiss={onDismiss} headerBackground={theme.colors.gradients.cardHeader}>
      ...
      <Flex alignItems="flex-start" justifyContent="space-between">
        ...
        <Flex flexDirection="column">
          <Text bold>{cakeBountyToDisplay} BUNNYMOON</Text>
