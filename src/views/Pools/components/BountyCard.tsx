...
const BountyCard = () => {
  ...
  const TooltipComponent = () => (
    <>
      ...
      <Text mb="16px">
        {t(
          'Whenever you successfully claim the bounty, you’re also helping out by activating the Auto BUNNYMOON Pool’s compounding function for everyone.',
        )}
      </Text>
      <Text style={{ fontWeight: 'bold' }}>
        {t(`Auto-Compound Bounty: %fee%% of all Auto BUNNYMOON pool users’ pending yield`, { fee: callFee / 100 })}
      </Text>
    </>
  )
