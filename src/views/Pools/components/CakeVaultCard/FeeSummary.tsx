...
import { Text, Flex, useTooltip, TooltipText } from '@bunnymoon-libs/uikit'
...
const FeeSummary: React.FC<FeeSummaryProps> = ({ stakingTokenSymbol, lastDepositedTime, vaultFees, stakeAmount }) => {
  ...
  const { targetRef, tooltip, tooltipVisible } = useTooltip(
    <>
      ...
      <Text>
        {t(
          'Only applies within 3 days of staking. Unstaking after 3 days will not include a fee. Timer resets every time you stake new BUNNYMOON in the pool.',
        )}
      </Text>
    </>,
    { placement: 'top-start' },
