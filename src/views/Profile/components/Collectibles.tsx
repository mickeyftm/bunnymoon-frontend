...
import { Heading, Text, Flex, ChevronRightIcon } from '@bunnymoon-libs/uikit'
...
const Collectibles = () => {
  ...
  return (
    <>
      ...
      <Text as="p">
        {t('Pancake Collectibles are special ERC-721 NFTs that can be used on the BunnyMoonFarm platform.')}
      </Text>
      <Text as="p">
