...
import { AutoRenewIcon, Button, Checkbox, Flex, InjectedModalProps, Text } from '@bunnymoon-libs/uikit'
...
const PauseProfilePage: React.FC<PauseProfilePageProps> = ({ onDismiss }) => {
  ...
  return (
    <>
      ...
      <Text as="p" color="textSubtle" mb="24px">
        {t(`Cost to reactivate in future: ${getBalanceNumber(numberCakeToReactivate)} BUNNYMOON`)}
      </Text>
