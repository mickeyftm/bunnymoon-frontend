...
import { Button, Flex, Text, InjectedModalProps } from '@bunnymoon-libs/uikit'
...
const StartPage: React.FC<StartPageProps> = ({ goToApprove, goToChange, goToRemove, onDismiss }) => {
  ...
  /**
   * Check if the wallet has the required BUNNYMOON allowance to change their profile pic or reactivate
      ...
      <Flex alignItems="center" style={{ height: '48px' }} justifyContent="center">
        <Text as="p" color="failure">
          {!hasMinimumCakeRequired &&
            t(`${getFullDisplayBalance(minimumCakeRequired)} BUNNYMOON required to change profile pic`)}
        </Text>
      </Flex>
      {profile.isActive ? (
        <>
